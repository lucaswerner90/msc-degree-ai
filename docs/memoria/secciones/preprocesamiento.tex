...
Debido a que nuestro conjunto de datos no es muy grande, decidimos que el conjunto de entrenamiento sea el 90%, del cual el 80% se usará para la fase de entrenamiento de nuestro modelo y el otro 20% se usará para la fase de test.
\medskip
